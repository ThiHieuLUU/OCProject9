...
from django.contrib.messages import constants as messages  # add messages
import os
...
SECRET_KEY = 'django-insecure-q1356h3dkh(sa3-pwm=i*ttp3g2nuwvv&1e0e1!l#3067d@f2c'
...
STATIC_URL = '/static/'
STATICFILES_DIR = (os.path.join(BASE_DIR, 'static'))  # Add this
